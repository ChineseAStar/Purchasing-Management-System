...
<section class="publicMian ">
    ...
    <div class="right">
        <div class="location">
            ...
            <span><a href="Suppliers.do?pageIndex=1">供应商管理页面</a>>> 供应商修改页</span>
        </div>
        <div class="providerAdd">
            <form action="Suppliers.do?action=save&id=${supplier.id}" method="post">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div class="">
                    <label for="id">供应商编码：</label>
                    <input type="text" name="id" id="id" value="${supplier.id}" readonly="readonly" />
                    <span>*</span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="agent" id="agent" value="${supplier.agent}" />
                ...
                <div>
                    ...
                    <input type="text" name="address" id="address" value="${supplier.addr}"/>
                    <span></span>
                ...
                <div>
                    ...
                    <input type="text" name="bank" id="bank" value="${supplier.bank}"/>
                    <span></span>
                </div>
                <div>
                    <label for="account">账号：</label>
                    <input type="text" name="account" id="account" value="${supplier.account}"/>
                    <span></span>
                </div>
